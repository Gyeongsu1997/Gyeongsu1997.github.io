...
스타일드 컴포넌트는 대표적인 CSS-in-JS 라이브러리입니다. 스타일드 컴포넌트를 사용하면 자바스크립트 파일 안에서 CSS 스타일을 편리하게 작성할 수 있습니다. 오늘의 포스팅에서는 스타일드 컴포넌트에서 사용되는 tagged templates이라는 문법에 대해 알아본 뒤 직접 스타일드 컴포넌트를 구현해보겠습니다. 
